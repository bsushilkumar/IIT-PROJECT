...
public class GlobalVar {
	...
	//Sneha : introduced new
	public static LoopInputDialog getLoopInputDialog() {
		return loopInputDialog;
	}

	//Sneha : introduced new
	public static LoopInputDialog setLoopInputDialog(String station) {
		if (loopInputDialog == null)
			loopInputDialog = new LoopInputDialog(station);
		return loopInputDialog;
	}
	...
	public static String getDirectionStringFromDirection(int direction) {
		...
		{dirString="up";
		System.out.println("dir string: " + dirString + "GlobalVar.UP direction: " + GlobalVar.UP_DIRECTION );
		   return dirString;
				   
		}
		else if (direction == GlobalVar.DOWN_DIRECTION)
		{dirString="down";
		System.out.println("dir string: " + dirString + "GlobalVar.UP direction: " + GlobalVar.DOWN_DIRECTION );
		   return dirString;
		...
		{
			dirString="common";
			System.out.println("dir string: " + dirString + "GlobalVar.UP direction: " + GlobalVar.COMMON_DIRECTION );
			return dirString;
