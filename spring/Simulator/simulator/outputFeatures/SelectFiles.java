...
public class SelectFiles extends JFrame {
	...
	public void autoselect () {
		...
		System.out.println("In autoselect");
			String temp="E:\\sneha\\test";
			directoryTextField.setText(temp);
			stationTextField.setText("station.txt");
			blockTextField.setText("block.txt");
			loopTextField.setText("loop.txt");
			parameterTextField.setText("param.dat");
			...
			FileNames.setScheduledTrainsFileName(scheduledTextField.getText());
			...
			FileNames.setGradientEffectsFileName(gradientEffectTextField.getText());
			//FileNames.setPassengerDelayFileName(passengerDelayTextField.getText());
			FileNames.setBlockDirectionFileName(blockDirectionInIntervalTextField.getText());
